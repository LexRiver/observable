...
exports.ObservableVariable = void 0;
var type_event_1 = require("@lexriver/type-event");
var ObservableVariable = /** @class */ (function () {
    function ObservableVariable(value) {
        this.value = value;
        this.eventOnChange = new type_event_1.TypeEvent();
    }
    ObservableVariable.prototype.set = function (value) {
    ...
    ObservableVariable.prototype.setByPrevious = function (setter) {
        var prevValue = this.value;
    ...
    ObservableVariable.prototype.get = function () {
        return this.value;
    };
